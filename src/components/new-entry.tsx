...
const sendEntry = async () => {
   ...
   try {
    setSpinner(true);
    await axios.post(`${import.meta.env.VITE_BASE_URL}/journal/insertJournal`,{userId, title: journal.title, content: journal.content}, {
      headers: {
    ...
    if(error.response.data == 'Token Expired'){
      ...
      console.log('Error at new-entry.tsx : \n',error);
    }
  } finally {
    setSpinner(false);
  }
          ...
          <div className="h-full flex flex-col">
             <div className="h-1/2 flex">
                 <div className="flex flex-col space-y-2 w-1/2 h-full">
                    ...
                    <TextBox name="title" type="text" onChange={handleInput}/>
                 </div>
